...
add_employee_screen addemployee_event = new add_employee_screen();
submit_button.addActionListener(addemployee_event);
administrativeoptions_button.addActionListener(addemployee_event);
}


public class add_employee_screen implements ActionListener 
{
public void actionPerformed(ActionEvent add_employee_events) 
{
	


	if (add_employee_events.getSource().equals(administrativeoptions_button))
	{
		setVisible(false);
	...
	else if (add_employee_events.getSource().equals(submit_button))
	{
		...
		String role_holder = role_textfield.getText();
		...
		if(firstname_holder.isEmpty() || lastname_holder.isEmpty() || role_holder.isEmpty() || subordinateof_holder.isEmpty() || employeeid_holder.isEmpty())
		...
		else
		{
			...
			try {
				...
				{
					client.sendToServer("A:"+employeeid_textfield.getText()+":"
				...
				role_holder+":"+subordinateof_holder+":"+password_holder);
					client.setLocation("A");
				}	
			} catch (Exception e) {
				e.printStackTrace();
			}
